...
function getData() {
    ...
    title.innerHTML = 'I am working in my Laptop';
    excerpt.innerHTML = 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis, quaerat!';
    profile_img.innerHTML = '<img src="https://randomuser.me/api/portraits/women/60.jpg" alt="" />';
    name.innerHTML = 'Mounika Ch';
    date.innerHTML = 'Aug 21, 2022';
